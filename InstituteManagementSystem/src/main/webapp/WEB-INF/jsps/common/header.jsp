					...
					<c:when test="${stud.id!=null}">
						<a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
							...
							<div class="nav-profile-img">
								<img src="${pageContext.request.contextPath}/resources/uploads/${stud.filename}" alt="image"> <span
									class="availability-status online"></span>
							</div>
							<div class="nav-profile-text">
								<p class="mb-1 text-black">${stud.name} ${stud.surname}</p>
							</div>
						</a>
						<div class="dropdown-menu navbar-dropdown"
							...
							<a class="dropdown-item" href="adminindex"> <i
								class="mdi mdi-logout mr-2 text-primary"></i> Signout
							</a>
						</div>
					</c:when>
					<c:otherwise>
						<a class="nav-link dropdown-toggle" id="profileDropdown" href="aboutadmin"
							data-toggle="dropdown" aria-expanded="false">
							<div class="nav-profile-img">
								<img src="${pageContext.request.contextPath}/resources/uploads/vinit.jpg" alt="image"> <span
									class="availability-status online"></span>
							</div>
							<div class="nav-profile-text">
				...
				data-toggle="dropdown" aria-expanded="false"><a
					...
					data-toggle="dropdown" aria-expanded="false"> <c:choose>
							<c:when test="${stud.id!=null}">
								<div class="nav-profile-img">
									<img
										src="${pageContext.request.contextPath}/resources/uploads/vinit"
							...
							<c:otherwise>
								<div class="nav-profile-img">
									<img
										src="${pageContext.request.contextPath}/resources/uploads/vinit.jpg"
										alt="image"> <span class="availability-status online"></span>
									<div class="nav-profile-text">
										<p class="mb-1 text-black">Admin</p>
									</div>
				...
				<div
					...
					<a class="dropdown-item preview-item">
						...
						<div
							...
							<h6 class="preview-subject ellipsis mb-1 font-weight-normal">Rahul
					...
					<a class="dropdown-item preview-item">
						...
						<div
							class="preview-item-content d-flex align-items-start flex-column justify-content-center">
							<h6 class="preview-subject ellipsis mb-1 font-weight-normal">Komal
								send you a message</h6>
